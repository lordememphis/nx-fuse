...
export class LanguagesComponent implements OnInit, OnDestroy {
  availableLangs: (string | LangDefinition)[] = [];
  activeLang!: string;
  flagCodes: any;
  ...
  // FIXME: Custom helper methods

  isLangDefinition = (obj: any): obj is LangDefinition => 'id' in obj && 'label' in obj;

  id = (lang: any): string => (this.isLangDefinition(lang) ? lang.id : lang);

  label = (lang: any): string => (this.isLangDefinition(lang) ? lang.label : lang);
